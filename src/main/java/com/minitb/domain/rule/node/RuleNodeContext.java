...
public interface RuleNodeContext {
     ...
     * @param error 错误信息
     */
    void tellFailure(TbMsg msg, Throwable error);
     ...
     */
    void processAsync(TbMsg msg, Consumer<TbMsg> processor, 
     ...
     * 创建新的消息
     */
    TbMsg createMsg(String type, String data, Map<String, String> metadata);
    
    /**
     * 创建设备消息
     */
    TbMsg createDeviceMsg(DeviceId deviceId, String type, String data);
    
    /**
     * 创建资产消息
     */
    TbMsg createAssetMsg(AssetId assetId, String type, String data);
